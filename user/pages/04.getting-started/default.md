...
<section class="smallContainer">
    ...
    <div class="tabsWrap">
        ...
        <div id="windows" class="tabcontent"><!-- windows -->
            ...
            <a href="#">Subutai Control Center x64 7.x</a>
            <small>Check the For Developers box to display and download the developer and master versions.
You may access and test these versions accordingly.</small>
            <div>
                <a href="#">For Developers</a>
                <div>
                    <a href="#">Subutai Control Center x64 Dev</a>
                    <a href="#">Subutai Control Center x64 Master</a>
                </div>
            ...
            <h4>You can download the package for Mac (64-bit): Subutai P2P for Mac OS X ( 64 bit ) 8.x</h4>
            <small>Check the For Developers box to display and download the developer and master versions.
You may access and test these versions accordingly.</small>
<a href="#">For Developers</a>
            <div>
