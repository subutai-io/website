...
/* Created by Master on 21.04.2015. */
/*Script sidebar project*/
( function( $ ) {
    $( document ).ready(function() {
...
/*Tabcontent project tabbed menu*/
(function () {
    var g = function (a) {
        ...
        if (!a(b, c))if (b.className == "")b.className = c; else if (d)b.className = c + " " + b.className; else b.className += " " + c
    }, h = function (a, b) {
        var c = new RegExp("(^| )" + b + "( |$)");
    ...
    b.prototype = {
        h: function () {
            ...
            for (var b = 0, c = this.b.length; b < c; b++)if (a(this.b[b].parentNode, "selected"))return b;
            return 0
        }, j: function (b, d) {
    ...
    var k = [], i = function (e) {
        ...
        for (var d = document.getElementsByTagName("ul"), c = 0, e = d.length; c < e; c++)a(d[c], "tabbed") && k.push(new b(d[c], c))
    };
    i(f);
    return {}
})();
